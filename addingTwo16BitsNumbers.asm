...
{add pom7, 0000h, rm,z;load rm_z,flags;}	\\ dodanie do pom1 pom1 + rq i zapoamietaj q pom1

{end;}
 \\ wyzeruj z pom4 pierwsza druga czwarta liczba and'em, xor'em sprawdz czy na 3 pozycji jest 7, jesli rm_z = 1 to obroc w lewo, 0 -w prawo
obliczadr{load rm,z;}
